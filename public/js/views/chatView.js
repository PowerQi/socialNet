define(['SocialNetView', 'views/chatsessionView', 'views/chatitemView', 'text!templates/chat.html'], 
function(SocialNetView, ChatSessionView, ChatItemView, chatItemTemplate){
    var chatView = SocialNetView.extend({
        ...
        initialize: function(options){
            ...
            this.collectoin.on('reset', this.renderCollection, this);
        },
        ...
        renderCollection: function(collection){
            ...
            collection.each(function(contact){
                var charItemView = new ChatItemView({
